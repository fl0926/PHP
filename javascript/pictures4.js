...
function processResponse(data){
    ...
    document.getElementById("outer-output").appendChild(hitsDiv);

    document.getElementById("outer-output").appendChild(createPager(data));

    var outputDiv = document.createElement("DIV");
    outputDiv.className="output";
    outputDiv.id="output";
    document.getElementById("outer-output").appendChild(outputDiv);
